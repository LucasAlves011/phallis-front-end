...
const SelectItem = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof SelectPrimitive.Item> & { hideIndicator?: boolean; indicatorSide?: 'left' | 'right' }
>(({ className, children, hideIndicator, indicatorSide = 'right', ...props }, ref) => (
